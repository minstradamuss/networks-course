...
![image](https://github.com/user-attachments/assets/c5fa70bd-7593-4a88-bee9-e980c0532099)

2. Найдите заголовок IP-пакета. Какое значение указано здесь в поле протокола верхнего уровня?
   - ICMP (1)

![image](https://github.com/user-attachments/assets/dc99d844-0486-4797-9824-721a86ec60de)

3. Сколько байт в IP-заголовке? Сколько байт приходится на полезную нагрузку IP-дейтаграммы?
   - 20 байт
   - 56 - 20 = 36 байт

![image](https://github.com/user-attachments/assets/a7bdbccd-3c74-440b-b43a-f1bbe5bd5540)
...
![image](https://github.com/user-attachments/assets/4f2e83c2-1fe5-4155-bb14-291eb85778f3)
   ...
   2. Какие поля не меняются? Какие поля должны оставаться неизменными? Какие
      ...
      - Source IP, Destination IP, Version, Header Length, Protocol, Total Length 
      - Source IP, Destination IP, Version, Header Length, Protocol, Total Length 
      - Identification, Time To Live (TTL), Header Checksum
   3. Как изменяется значение поля Identification IP-дейтаграммы с каждым
      ...
      - да
      - просто увеличивается на 1
5. Какое значение содержится в поле Identification (Идентификация), а какое – в поле TTL
   (выберите какой-либо один пакет ICMP)?
   - Identification: 0x895c (35164)
   - Time to Live: 255

![image](https://github.com/user-attachments/assets/2851525a-4170-4d24-8a01-609ae9539ab8)
...
![image](https://github.com/user-attachments/assets/ec5042aa-80fa-4775-921d-c6e27905800d)
...
![image](https://github.com/user-attachments/assets/d33c3f21-58ee-42aa-ba86-a10129f8a2b2)

   2. Какие поля IP-заголовка изменяются в разных фрагментах?
      - Flags, Fragment Offset, Total Length, Header Checksum
